const tetsimonialsModal = require('../../models/tetstimonials');
...
exports.create = async (request, response) => {
    ...
    try {
        ...
        var saveData = new tetsimonialsModal(data).save()
            .then((result) => {
                const data = {
                    _status: true,
...
exports.view = async (request, response) => {
    ...
    try {
        ...
        total_record = await tetsimonialsModal.find(filter).countDocuments()

        await tetsimonialsModal.find(filter).select('name image status order message rating designation').skip(skip).limit(limit).sort({ _id: 'desc' })
            .then((result) => {
                if (result.length > 0) {
                    ...
                    const data = {
                        ...
                        _paginate: paginate,
                        _image_path: process.env.testimonials_image,
                        _data: result
                    }
                    response.send(data);
                } else {
...
exports.details = async (request, response) => {
    ...
    try {
        ...
        await tetsimonialsModal.findById(request.params.id)
            .then((result) => {
                if (result) {
                    const data = {
                        _status: true,
...
exports.update = async (request, response) => {
    try {
        ...
        await tetsimonialsModal.updateOne({
...
exports.destroy = async (request, response) => {
    try {
        ...
        await tetsimonialsModal.updateMany({
